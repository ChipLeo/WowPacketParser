...
using MovementFlag720 = WowPacketParserModule.V7_2_0_23758.Enums.MovementFlag;
    ...
    public static class UpdateHandler
    {
        ...
        private static MovementInfo ReadMovementUpdateBlock(Packet packet, WowGuid guid, WoWObject obj, object index)
        {
            ...
            if (hasMovementUpdate)
            {
                ...
                moveInfo.Flags = (MovementFlag)packet.ReadBitsE<MovementFlag720>("Movement Flags", 30, index);
            ...
            if (sceneObjCreate)
            {
                ...
                if (petBattleFullUpdate)
                    Parsers.BattlePetHandler.ReadPetBattleFullUpdate(packet, index);
            }
