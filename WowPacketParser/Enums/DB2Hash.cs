...
namespace WowPacketParser.Enums
{
    ...
    public enum DB2Hash : uint
    {
        ...
        BattlePetAbility                = 0xCBA43BD7, // 6.2.0.20182
        BattlePetAbilityEffect          = 0xDD8B690E, // 6.2.0.20182
        BattlePetAbilityState           = 0x3C556E43, // 6.2.0.20182
        BattlePetAbilityTurn            = 0xECD8ECDC, // 6.2.0.20182
        BattlePetBreedQuality           = 0x1B5A4EA6,
        BattlePetBreedState             = 0x6AFB3206, // 6.2.0.20182
        BattlePetEffectProperties       = 0x63B4C4BA,
        BattlePetNPCTeamMember          = 0xF2059DFA,
        BattlePetSpecies                = 0x6C93F9B1, // 6.2.0.20182
        BattlePetSpeciesState           = 0x15D87DD0, // 6.2.0.20182
        BattlePetSpeciesXAbility        = 0x44237314, // 6.2.0.20182
        ...
        GameObjects                     = 0x13C403A5, // 6.2.0.20182
        ...
        SceneScript                     = 0xD4B163CC, // 6.2.0.20182
        SceneScriptPackage              = 0xE8CB5E09, // 6.2.0.20182
        SceneScriptPackageMember        = 0xE44DB71C, // 6.2.0.20182
