...
namespace WowPacketParser.Enums.Version.V5_4_7_17898
{
    public static class Opcodes_5_4_7
    {
        ...
        private static readonly BiDictionary<Opcode, int> ClientOpcodes = new BiDictionary<Opcode, int>
        {
            ...
            {Opcode.CMSG_CHAT_JOIN_CHANNEL, 0x1D20}, // 5.4.7 18019
            {Opcode.CMSG_CHAT_LEAVE_CHANNEL, 0x0E0B}, // 5.4.7 18019
            {Opcode.CMSG_CHAT_MESSAGE_AFK, 0x0422}, // 5.4.7 18019
            {Opcode.CMSG_CHAT_MESSAGE_BATTLEGROUND, 0x0F02}, // 5.4.7 18019
            {Opcode.CMSG_CHAT_MESSAGE_CHANNEL, 0x0904}, // 5.4.7 18019
            {Opcode.CMSG_CHAT_MESSAGE_DND, 0x1E21}, // 5.4.7 18019
            {Opcode.CMSG_CHAT_MESSAGE_EMOTE, 0x0520}, // 5.4.7 18019
            {Opcode.CMSG_CHAT_MESSAGE_GUILD, 0x070B}, // 5.4.7 18019
            {Opcode.CMSG_CHAT_MESSAGE_OFFICER, 0x1F69}, // 5.4.7 18019
            {Opcode.CMSG_CHAT_MESSAGE_PARTY, 0x0642}, // 5.4.7 18019
            {Opcode.CMSG_CHAT_MESSAGE_RAID, 0x054B}, // 5.4.7 18019
            {Opcode.CMSG_CHAT_MESSAGE_RAID_WARNING, 0x0423}, // 5.4.7 18019
            {Opcode.CMSG_CHAT_MESSAGE_SAY, 0x0C41}, // 5.4.7 18019
            {Opcode.CMSG_CHAT_MESSAGE_WHISPER, 0x0D60}, // 5.4.7 18019
            {Opcode.CMSG_CHAT_MESSAGE_YELL, 0x0C43}, // 5.4.7 18019
            ...
            {Opcode.CMSG_CLIENT_PORT_GRAVEYARD, 0x0257}, // 5.4.7 18019
            ...
            {Opcode.CMSG_CONTACT_LIST, 0x1186}, // 5.4.7 18019
            {Opcode.CMSG_CORPSE_MAP_POSITION_QUERY, 0x0DA2}, // 5.4.7 18019
            {Opcode.CMSG_CORPSE_QUERY, 0x129B}, // 5.4.7 18019
            {Opcode.CMSG_CREATE_CHARACTER, 0x09B9}, // 5.4.7 18019
            {Opcode.CMSG_DB_QUERY_BULK, 0x16C2}, // 5.4.7 18019
            {Opcode.CMSG_DEL_FRIEND, 0x1707}, // 5.4.7 18019
            {Opcode.CMSG_DEL_IGNORE, 0x0385}, // 5.4.7 18019
            {Opcode.CMSG_DESTROY_ITEM, 0x1F12}, // 5.4.7 18019
            {Opcode.CMSG_DISMISS_CONTROLLED_VEHICLE, 0x0979}, // 5.4.7 18019
            {Opcode.CMSG_DO_READY_CHECK, 0x0D88}, // 5.4.7 18019
            ...
            {Opcode.CMSG_EQUIPMENT_SET_USE, 0x1402}, // 5.4.7 18019
            {Opcode.CMSG_FAR_SIGHT, 0x01D5}, // 5.4.7 18019
            {Opcode.CMSG_FORCE_MOVE_ROOT_ACK, 0x0118}, // 5.4.7 18019
            {Opcode.CMSG_FORCE_MOVE_UNROOT_ACK, 0x0458}, // 5.4.7 18019
            {Opcode.CMSG_GAME_OBJ_REPORT_USE, 0x06DF}, // 5.4.7 18019
            {Opcode.CMSG_GAME_OBJ_USE, 0x055F}, // 5.4.7 18019
            {Opcode.CMSG_GAME_STORE_LIST, 0x1993}, // 5.4.7 18019
            {Opcode.CMSG_GENERATE_RANDOM_CHARACTER_NAME, 0x1DB9}, // 5.4.7 18019
            {Opcode.CMSG_GET_ITEM_PURCHASE_DATA, 0x10DC}, // 5.4.7 18019
            ...
            {Opcode.CMSG_GOSSIP_HELLO, 0x05F6}, // 5.4.7 18019
            {Opcode.CMSG_GOSSIP_SELECT_OPTION, 0x02D7}, // 5.4.7 18019
            {Opcode.CMSG_GROUP_ASSIGNMENT, 0x18A2}, // 5.4.7 18019
            {Opcode.CMSG_GROUP_ASSISTANT_LEADER, 0x0DBB}, // 5.4.7 18019
            {Opcode.CMSG_GROUP_CHANGE_SUB_GROUP, 0x17D9}, // 5.4.7 18019
            {Opcode.CMSG_GROUP_DISBAND, 0x0DB2}, // 5.4.7 18019
            {Opcode.CMSG_GROUP_INVITE, 0x1990}, // 5.4.7 18019
            {Opcode.CMSG_GROUP_INVITE_RESPONSE, 0x1C51}, // 5.4.7 18019
            {Opcode.CMSG_GROUP_RAID_CONVERT, 0x19A0}, // 5.4.7 18019
            {Opcode.CMSG_GROUP_REQUEST_JOIN_UPDATES, 0x1792}, // 5.4.7 18019
            {Opcode.CMSG_GROUP_SET_LEADER, 0x1383}, // 5.4.7 18019
            {Opcode.CMSG_GROUP_SET_ROLES, 0x1C93}, // 5.4.7 18019
            {Opcode.CMSG_GROUP_SWAP_SUB_GROUP, 0x1D80}, // 5.4.7 18019 - CHECK!
            {Opcode.CMSG_GROUP_UNINVITE_GUID, 0x0989}, // 5.4.7 18019
            {Opcode.CMSG_GUILD_ACCEPT, 0x18A3}, // 5.4.7 18019
            {Opcode.CMSG_GUILD_ACHIEVEMENT_PROGRESS_QUERY, 0x1B3D}, // 5.4.7 18019
            {Opcode.CMSG_GUILD_ADD_RANK, 0x1935}, // 5.4.7 18019
            {Opcode.CMSG_GUILD_ASSIGN_MEMBER_RANK, 0x198F}, // 5.4.7 18019
            {Opcode.CMSG_GUILD_BANK_ACTIVATE, 0x02F6}, // 5.4.7 18019
            {Opcode.CMSG_GUILD_BANK_BUY_TAB, 0x02D6}, // 5.4.7 18019
            {Opcode.CMSG_GUILD_BANK_DEPOSIT_MONEY, 0x03FC}, // 5.4.7 18019
            {Opcode.CMSG_GUILD_BANK_LOG_QUERY, 0x1D97}, // 5.4.7 18019
            {Opcode.CMSG_GUILD_BANK_QUERY_TAB, 0x07DC}, // 5.4.7 18019
            ...
            {Opcode.CMSG_GUILD_DECLINE_INVITATION, 0x1B05}, // 5.4.7 18019
            {Opcode.CMSG_GUILD_DELETE_RANK, 0x1D3C}, // 5.4.7 18019
            {Opcode.CMSG_GUILD_DEMOTE_MEMBER, 0x1B1C}, // 5.4.7 18019 - Not finished - CHECK!
            {Opcode.CMSG_GUILD_DISBAND, 0x190E}, // 5.4.7 18019
            {Opcode.CMSG_GUILD_EVENT_LOG_QUERY, 0x1D17}, // 5.4.7 18019
            {Opcode.CMSG_GUILD_GET_RANKS, 0x1BBC}, // 5.4.7 18019
            {Opcode.CMSG_GUILD_GET_ROSTER, 0x19BC}, // 5.4.7 18019
            {Opcode.CMSG_GUILD_INFO_TEXT, 0x1DAD}, // 5.4.7 18019
            {Opcode.CMSG_GUILD_INVITE, 0x188B}, // 5.4.7 18019
            {Opcode.CMSG_GUILD_LEAVE, 0x193D}, // 5.4.7 18019
            {Opcode.CMSG_GUILD_MOTD, 0x1DB4}, // 5.4.7 18019
            {Opcode.CMSG_GUILD_NEWS_UPDATE_STICKY, 0x1984}, // 5.4.7 18019
            {Opcode.CMSG_GUILD_OFFICER_REMOVE_MEMBER, 0x1D9F}, // 5.4.7 18019
            {Opcode.CMSG_GUILD_PERMISSIONS_QUERY, 0x1D0F}, // 5.4.7 18019
            {Opcode.CMSG_GUILD_PROMOTE_MEMBER, 0x19B5}, // 5.4.7 18019 - Not finished - CHECK!
            {Opcode.CMSG_GUILD_QUERY_NEWS, 0x1D35}, // 5.4.7 18019
            ...
            {Opcode.CMSG_GUILD_SET_GUILD_MASTER, 0x189B}, // 5.4.7 18019
            {Opcode.CMSG_GUILD_SET_NOTE, 0x1905}, // 5.4.7 18019
            {Opcode.CMSG_GUILD_SET_RANK_PERMISSIONS, 0x19BD}, // 5.4.7 18019
            ...
            {Opcode.CMSG_INSPECT, 0x01D4}, // 5.4.7 18019
            {Opcode.CMSG_INSPECT_HONOR_STATS, 0x141A}, // 5.4.7 18019
            ...
            {Opcode.CMSG_LFG_JOIN, 0x18B8}, // 5.4.7 18019
            {Opcode.CMSG_LFG_LEAVE, 0x0D83}, // 5.4.7 18019
            {Opcode.CMSG_LFG_PLAYER_LOCK_INFO_REQUEST, 0x19AA}, // 5.4.7 18019
            {Opcode.CMSG_LFG_PROPOSAL_RESULT, 0x1C99}, // 5.4.7 18019
            {Opcode.CMSG_LFG_SET_BOOT_VOTE, 0x1CBA}, // 5.4.7 18019
            {Opcode.CMSG_LFG_SET_COMMENT, 0x1C88}, // 5.4.7 18019
            {Opcode.CMSG_LFG_SET_ROLES, 0x1A9B}, // 5.4.7 18019
            {Opcode.CMSG_LFG_TELEPORT, 0x1999}, // 5.4.7 18019
            ...
            {Opcode.CMSG_LIST_INVENTORY, 0x10DD}, // 5.4.7 18019
            {Opcode.CMSG_LOADING_SCREEN_NOTIFY, 0x1691}, // 5.4.7 18019
            {Opcode.CMSG_LOGOUT_CANCEL, 0x11D4}, // 5.4.7 18019
            {Opcode.CMSG_LOGOUT_REQUEST, 0x0476}, // 5.4.7 18019
            {Opcode.CMSG_LOG_DISCONNECT, 0x1A13}, // 5.4.7 18019
            {Opcode.CMSG_LOOT_MASTER_GIVE, 0x14A1}, // 5.4.7 18019
            {Opcode.CMSG_LOOT_MONEY, 0x15A0}, // 5.4.7 18019
            {Opcode.CMSG_LOOT_RELEASE, 0x12F0}, // 5.4.7 18019
            {Opcode.CMSG_LOOT_ROLL, 0x1F53}, // 5.4.7 18019
            {Opcode.CMSG_LOOT_UNIT, 0x1E52}, // 5.4.7 18019
            {Opcode.CMSG_MAIL_CREATE_TEXT_ITEM, 0x0254}, // 5.4.7 18019
            {Opcode.CMSG_MAIL_DELETE, 0x13A3}, // 5.4.7 18019
            {Opcode.CMSG_MAIL_GET_LIST, 0x07DD}, // 5.4.7 18019
            ...
            {Opcode.CMSG_MOVE_TIME_SKIPPED, 0x0152}, // 5.4.7 18019
            {Opcode.CMSG_MOVE_WATER_WALK_ACK, 0x0519}, // 5.4.7 18019 - CHECK!
            {Opcode.CMSG_NAME_QUERY, 0x0DB3}, // 5.4.7 18019
            {Opcode.CMSG_NEXT_CINEMATIC_CAMERA, 0x05CC}, // 5.4.7 18019
            {Opcode.CMSG_OBJECT_UPDATE_FAILED, 0x0882}, // 5.4.7 18019
            ...
            {Opcode.CMSG_PING, 0x1070}, // 5.4.7 18019
            {Opcode.CMSG_PLAYER_DIFFICULTY_CHANGE, 0x09A8}, // 5.4.7 18019 Not implemented - CHECK!
            {Opcode.CMSG_PLAYER_LOGIN, 0x17D3}, // 5.4.7 18019
            ...
            {Opcode.CMSG_QUERY_CREATURE, 0x1E72}, // 5.4.7 18019
            {Opcode.CMSG_QUERY_GAME_OBJECT, 0x14EA}, // 5.4.7 18019
            {Opcode.CMSG_QUERY_GUILD_INFO, 0x1280}, // 5.4.7 18019
            {Opcode.CMSG_QUERY_INSPECT_ACHIEVEMENTS, 0x047E}, // 5.4.7 18019
            {Opcode.CMSG_QUERY_NEXT_MAIL_TIME, 0x05F7}, // 5.4.7 18019
            {Opcode.CMSG_QUERY_NPC_TEXT, 0x12FA}, // 5.4.7 18019
            {Opcode.CMSG_QUERY_PAGE_TEXT, 0x13B1}, // 5.4.7 18019
            {Opcode.CMSG_QUERY_PET_NAME, 0x16A3}, // 5.4.7 18019
            {Opcode.CMSG_QUERY_QUEST_INFO, 0x1F52}, // 5.4.7 18019
            {Opcode.CMSG_QUERY_REALM_NAME, 0x1899}, // 5.4.7 18019
            {Opcode.CMSG_QUERY_TIME, 0x03FD}, // 5.4.7 18019
            {Opcode.CMSG_QUERY_VOID_STORAGE, 0x01E1}, // 5.4.7 18019
            {Opcode.CMSG_QUEST_CONFIRM_ACCEPT, 0x0277}, // 5.4.7 18019
            {Opcode.CMSG_QUEST_GIVER_ACCEPT_QUEST, 0x0356}, // 5.4.7 18019
            {Opcode.CMSG_QUEST_GIVER_CHOOSE_REWARD, 0x075F}, // 5.4.7 18019
            {Opcode.CMSG_QUEST_GIVER_COMPLETE_QUEST, 0x115E}, // 5.4.7 18019
            {Opcode.CMSG_QUEST_GIVER_HELLO, 0x1056}, // 5.4.7 18019
            {Opcode.CMSG_QUEST_GIVER_QUERY_QUEST, 0x0474}, // 5.4.7 18019
            {Opcode.CMSG_QUEST_GIVER_REQUEST_REWARD, 0x107E}, // 5.4.7 18019
            {Opcode.CMSG_QUEST_GIVER_STATUS_MULTIPLE_QUERY, 0x0275}, // 5.4.7 18019
            {Opcode.CMSG_QUEST_GIVER_STATUS_QUERY, 0x05FD}, // 5.4.7 18019
            {Opcode.CMSG_QUEST_LOG_REMOVE_QUEST, 0x0655}, // 5.4.7 18019
            {Opcode.CMSG_QUEST_NPC_QUERY, 0x16B8}, // 5.4.7 18019 //1DA8 CMSG_QUERY_QUEST_COMPLETION_NPCS
            {Opcode.CMSG_QUEST_POI_QUERY, 0x1DA8}, // 5.4.7 18019 //16B8
            {Opcode.CMSG_RANDOM_ROLL, 0x1891}, // 5.4.7 18019
            {Opcode.CMSG_READY_CHECK_RESPONSE, 0x13D9}, // 5.4.7 18019
            {Opcode.CMSG_READY_FOR_ACCOUNT_DATA_TIMES, 0x13CB}, // 5.4.7 18019
            {Opcode.CMSG_READ_ITEM, 0x14C5}, // 5.4.7 18019
            {Opcode.CMSG_REALM_SPLIT, 0x1282}, // 5.4.7 18019
            {Opcode.CMSG_RECLAIM_CORPSE, 0x065C}, // 5.4.7 18019
            {Opcode.CMSG_REFORGE_ITEM, 0x1632}, // 5.4.7 18019
            {Opcode.CMSG_REORDER_CHARACTERS, 0x1892}, // 5.4.7 18019
            {Opcode.CMSG_REPAIR_ITEM, 0x0577}, // 5.4.7 18019
            {Opcode.CMSG_REPOP_REQUEST, 0x04FC}, // 5.4.7 18019
            ...
            {Opcode.CMSG_REQUEST_GUILD_PARTY_STATE, 0x14A8}, // 5.4.7 18019
            {Opcode.CMSG_REQUEST_GUILD_REWARDS_LIST, 0x171B}, // 5.4.7 18019
            {Opcode.CMSG_REQUEST_GUILD_XP, 0x1D37}, // 5.4.7 18019
            {Opcode.CMSG_REQUEST_INSPECT_RATED_BG_STATS, 0x1CB3}, // 5.4.7 18019
            {Opcode.CMSG_REQUEST_PARTY_MEMBER_STATS, 0x1333}, // 5.4.7 18019
            {Opcode.CMSG_REQUEST_PLAYED_TIME, 0x173A}, // 5.4.7 18019
            ...
            {Opcode.CMSG_SAVE_CUF_PROFILES, 0x0C88}, // 5.4.7 18019
            {Opcode.CMSG_SAVE_EQUIPMENT_SET, 0x115C}, // 5.4.7 18019
            ...
            {Opcode.CMSG_SET_LOOT_METHOD, 0x1C10}, // 5.4.7 18019
            ...
            {Opcode.CMSG_UPGRADE_ITEM, 0x11E9}, // 5.4.7 18019
        ...
        private static readonly BiDictionary<Opcode, int> ServerOpcodes = new BiDictionary<Opcode, int>
        {
            ...
            {Opcode.SMSG_ATTACK_SWING_ERROR, 0x04E0}, // 5.4.7 18019
            ...
            {Opcode.SMSG_BATTLE_PET_CHAT_RESTRICTED, 0x1F53}, // 5.4.7 18019 Not implemented - CHECK! These concern the battles themselves.
            {Opcode.SMSG_BATTLE_PET_DEBUG_QUEUE_DUMP_RESPONSE, 0x13E9}, // 5.4.7 18019 Not implemented - CHECK!
            ...
            {Opcode.SMSG_BATTLE_PET_FINAL_ROUND, 0x12F0}, // 5.4.7 18019 Not implemented - CHECK!
            {Opcode.SMSG_BATTLE_PET_FINISHED, 0x1E33}, // 5.4.7 18019 Not implemented - CHECK!
            {Opcode.SMSG_BATTLE_PET_FIRST_ROUND, 0x1612}, // 5.4.7 18019 Not implemented - CHECK!
            {Opcode.SMSG_BATTLE_PET_FULL_UPDATE, 0x01E3}, // 5.4.7 18019 Not implemented - CHECK!
            {Opcode.SMSG_BATTLE_PET_JOURNAL, 0x14A0}, // 5.4.7 18019
            {Opcode.SMSG_BATTLE_PET_JOURNAL_LOCK_ACQUIRED, 0x1C7A}, // 5.4.7 18019 Not implemented - CHECK!
            {Opcode.SMSG_BATTLE_PET_JOURNAL_LOCK_DENIED, 0x13E3}, // 5.4.7 18019 Not implemented - CHECK!
            {Opcode.SMSG_BATTLE_PET_LICENSE_CHANGED, 0x11E0}, // 5.4.7 18019 Not implemented - CHECK!
            {Opcode.SMSG_BATTLE_PET_MAX_GAME_LENGTH_WARNING, 0x12BB}, // 5.4.7 18019 Not implemented - CHECK!
            {Opcode.SMSG_BATTLE_PET_PVP_CHALLENGE, 0x1C08}, // 5.4.7 18019 Not implemented - CHECK!
            {Opcode.SMSG_BATTLE_PET_QUERY_NAME_RESPONSE, 0x0D01}, // 5.4.7 18019 Not implemented - CHECK!
            {Opcode.SMSG_BATTLE_PET_QUEUE_PROPOSE_MATCH, 0x0E62}, // 5.4.7 18019 Not implemented - CHECK!
            {Opcode.SMSG_BATTLE_PET_QUEUE_STATUS, 0x1540}, // 5.4.7 18019 Not implemented - CHECK!
            {Opcode.SMSG_BATTLE_PET_REPLACEMENTS_MADE, 0x0891}, // 5.4.7 18019 Not implemented - CHECK!
            {Opcode.SMSG_BATTLE_PET_ROUND_RESULT, 0x0709}, // 5.4.7 18019 Not implemented - CHECK!
            {Opcode.SMSG_BATTLE_PET_SLOT_UPDATE, 0x0421}, // 5.4.7 18019 Not implemented - CHECK!
            {Opcode.SMSG_BATTLE_PET_TRAP_LEVEL, 0x13AA}, // 5.4.7 18019 Not implemented - CHECK!
            {Opcode.SMSG_BATTLE_PET_UPDATES, 0x04E3}, // 5.4.7 18019 Not implemented - CHECK!
            {Opcode.SMSG_BINDER_CONFIRM, 0x0F22}, // 5.4.7 18019
            {Opcode.SMSG_BIND_POINT_UPDATE, 0x11E2}, // 5.4.7 18019
            {Opcode.SMSG_BLACK_MARKET_BID_ON_ITEM_RESULT, 0x064B}, // 5.4.7 18019
            {Opcode.SMSG_BLACK_MARKET_OPEN_RESULT, 0x15E2}, // 5.4.7 18019
            {Opcode.SMSG_BLACK_MARKET_OUTBID, 0x12A3}, // 5.4.7 18019
            {Opcode.SMSG_BLACK_MARKET_REQUEST_ITEMS_RESULT, 0x165A}, // 5.4.7 18019
            {Opcode.SMSG_BLACK_MARKET_WON, 0x04A9}, // 5.4.7 18019
            {Opcode.SMSG_BREAK_TARGET, 0x141A}, // 5.4.7 18019 // 0152
            {Opcode.SMSG_BUY_FAILED, 0x165B}, // 5.4.7 18019
            {Opcode.SMSG_BUY_SUCCEEDED, 0x0763}, // 5.4.7 18019
            {Opcode.SMSG_CACHE_VERSION, 0x1E41}, // 5.4.7 18019
            {Opcode.SMSG_CALENDAR_SEND_EVENT, 0x05E0}, // 5.4.7 18019 - CHECK!
            {Opcode.SMSG_CALENDAR_SEND_NUM_PENDING, 0x1C21}, // 5.4.7 18019
            {Opcode.SMSG_CANCEL_AUTO_REPEAT, 0x12B0}, // 5.4.7 18019
            {Opcode.SMSG_CANCEL_COMBAT, 0x1E48}, // 5.4.7 18019
            {Opcode.SMSG_CAST_FAILED, 0x0560}, // 5.4.7 18019
            {Opcode.SMSG_CHALLENGE_MODE_ALL_MAP_STATS, 0x1621}, // 5.4.7 18019 Not implemented - CHECK!
            {Opcode.SMSG_CHALLENGE_MODE_COMPLETE, 0x1D53}, // 5.4.7 18019 Not implemented - CHECK!
            {Opcode.SMSG_CHALLENGE_MODE_DELETE_LEADER_RESULT, 0x05A2}, // 5.4.7 18019 Not implemented - CHECK!
            {Opcode.SMSG_CHALLENGE_MODE_MAP_STATS_UPDATE, 0x0C9A}, // 5.4.7 18019 Not implemented - CHECK!
            {Opcode.SMSG_CHALLENGE_MODE_NEW_PLAYER_RECORD, 0x0C80}, // 5.4.7 18019 Not implemented - CHECK!
            {Opcode.SMSG_CHALLENGE_MODE_REQUEST_LEADERS_RESULT, 0x0668}, // 5.4.7 18019 Not implemented - CHECK!
            {Opcode.SMSG_CHALLENGE_MODE_REWARDS, 0x1413}, // 5.4.7 18019 Not implemented - CHECK!
            {Opcode.SMSG_CHANNEL_LIST, 0x06EE}, // 5.4.7 18019
            {Opcode.SMSG_CHANNEL_NOTIFY, 0x11C5}, // 5.4.7 18019
            {Opcode.SMSG_CHAR_CUSTOMIZE, 0x1F60}, // 5.4.7 18019
            {Opcode.SMSG_CHAT, 0x0E60}, // 5.4.7 18019
            {Opcode.SMSG_CHAT_SERVER_MESSAGE, 0x026E}, // 5.4.7 18019
            {Opcode.SMSG_CLEAR_COOLDOWN, 0x0C08}, // 5.4.7 18019
            {Opcode.SMSG_CLEAR_COOLDOWNS, 0x1926}, // 5.4.7 18019
            {Opcode.SMSG_CLEAR_TARGET, 0x12EB}, // 5.4.7 18019
            {Opcode.SMSG_COIN_REMOVED, 0x0C89}, // 5.4.7 18019
            {Opcode.SMSG_COMPLAINT_RESULT, 0x0D62}, // 5.4.7 18019
            {Opcode.SMSG_COMPRESSED_ACHIEVEMENT_DATA, 0x0062}, // 5.4.7 18019
            {Opcode.SMSG_CONNECT_TO, 0x05B9}, // 5.4.7 18019 - CHECK!
            {Opcode.SMSG_CONTACT_LIST, 0x15CF}, // 5.4.7 18019
            {Opcode.SMSG_CONTROL_UPDATE, 0x01EA}, // 5.4.7 18019
            {Opcode.SMSG_CONVERT_RUNE, 0x1E09}, // 5.4.7 18019
            {Opcode.SMSG_COOLDOWN_EVENT, 0x1C5B}, // 5.4.7 18019
            {Opcode.SMSG_CORPSE_MAP_POSITION_QUERY_RESPONSE, 0x1C73}, // 5.4.7 18019
            //{Opcode.SMSG_CORPSE_NOT_IN_INSTANCE, 0x1C3B}, // 5.4.7 18019
            {Opcode.SMSG_CORPSE_QUERY_RESPONSE, 0x1F32}, // 5.4.7 18019
            {Opcode.SMSG_CORPSE_RECLAIM_DELAY, 0x1E73}, // 5.4.7 18019
            {Opcode.SMSG_CREATE_CHAR, 0x1469}, // 5.4.7 18019
            {Opcode.SMSG_CRITERIA_DELETED, 0x0622}, // 5.4.7 18019
            {Opcode.SMSG_CRITERIA_UPDATE, 0x13B2}, // 5.4.7 18019
            {Opcode.SMSG_DB_REPLY, 0x1F01}, // 5.4.7 18019
            {Opcode.SMSG_DEATH_RELEASE_LOC, 0x1672}, // 5.4.7 18019
            {Opcode.SMSG_DEFENSE_MESSAGE, 0x01E8}, // 5.4.7 18019
            {Opcode.SMSG_DELETE_CHAR, 0x1529}, // 5.4.7 18019
            {Opcode.SMSG_DESTROY_OBJECT, 0x1D69}, // 5.4.7 18019
            ...
            {Opcode.SMSG_DUMP_OBJECTS_DATA, 0x12AA}, // 5.4.7 18019
            {Opcode.SMSG_DURABILITY_DAMAGE_DEATH, 0x1713}, // 5.4.7 18019
            {Opcode.SMSG_EMOTE, 0x022F}, // 5.4.7 18019
            {Opcode.SMSG_ENABLE_BARBER_SHOP, 0x0F6A}, // 5.4.7 18019
            {Opcode.SMSG_ENUM_CHARACTERS_RESULT, 0x040A}, // 5.4.7 18019
            ...
            {Opcode.SMSG_FEATURE_SYSTEM_STATUS, 0x1560}, // 5.4.7 18019
            {Opcode.SMSG_FRIEND_STATUS, 0x0707}, // 5.4.7 18019
            {Opcode.SMSG_GAMEOBJECT_DESPAWN_ANIM, 0x0609}, // 5.4.7 18019
            {Opcode.SMSG_GAME_OBJECT_ACTIVATE_ANIM_KIT, 0x0462}, // 5.4.7 18019
            {Opcode.SMSG_GAME_OBJECT_CUSTOM_ANIM, 0x1E52}, // 5.4.7 18019
            //{Opcode.SMSG_GAME_OBJECT_PAGE_TEXT, 0x0549}, // 5.4.7 18019
            {Opcode.SMSG_GAME_OBJECT_PLAY_SPELL_VISUAL, 0x0E68}, // 5.4.7 18019 - CHECK!
            {Opcode.SMSG_GAME_STORE_AUTH_BUY_FAILED, 0x0C40}, // 5.4.7 18019 Not implemented - CHECK!
            {Opcode.SMSG_GAME_STORE_LIST, 0x1C29}, // 5.4.7 18019
            {Opcode.SMSG_GAME_TIME_SET, 0x037E}, // 5.4.7 18019 - CHECK!
            {Opcode.SMSG_GAME_TIME_UPDATE, 0x00A3}, // 5.4.7 18019
            {Opcode.SMSG_GENERATE_RANDOM_CHARACTER_NAME_RESULT, 0x074B}, // 5.4.7 18019
            ...
            {Opcode.SMSG_GOSSIP_MESSAGE, 0x0E52}, // 5.4.7 18019
            {Opcode.SMSG_GOSSIP_POI, 0x058F}, // 5.4.7 18019
            {Opcode.SMSG_GROUP_DECLINE, 0x108F}, // 5.4.7 18019
            {Opcode.SMSG_GROUP_DESTROYED, 0x1564}, // 5.4.7 18019
            {Opcode.SMSG_GROUP_INVITE, 0x1472}, // 5.4.7 18019
            ...
            {Opcode.SMSG_GUILD_BANK_QUERY_RESULTS, 0x1B7B}, // 5.4.7 18019
            ...
            {Opcode.SMSG_GUILD_CHALLENGE_UPDATE, 0x1A33}, // 5.4.7 18019
            {Opcode.SMSG_GUILD_COMMAND_RESULT, 0x1A13}, // 5.4.7 18019
            ...
            {Opcode.SMSG_GUILD_INVITE, 0x185A}, // 5.4.7 18019
            {Opcode.SMSG_GUILD_KNOWN_RECIPES, 0x1A12}, // 5.4.7 18019 // sub_2A6ECC
            {Opcode.SMSG_GUILD_LEAVE, 0x1870}, // 5.4.7 18019
            {Opcode.SMSG_GUILD_MOTD, 0x1850}, // 5.4.7 18019
            {Opcode.SMSG_GUILD_NEWS_UPDATE, 0x187B}, // 5.4.7 18019
            {Opcode.SMSG_GUILD_PARTY_STATE, 0x1A52}, // 5.4.7 18019
            {Opcode.SMSG_GUILD_PERMISSIONS_QUERY_RESULTS, 0x1A32}, // 5.4.7 18019
            {Opcode.SMSG_GUILD_RANKS, 0x1271}, // 5.4.7 18019
            {Opcode.SMSG_GUILD_REPUTATION_WEEKLY_CAP, 0x1913}, // 5.4.7 18019
            {Opcode.SMSG_GUILD_REWARD_LIST, 0x1010}, // 5.4.7 18019
            {Opcode.SMSG_GUILD_ROSTER, 0x1231}, // 5.4.7 18019
            //{Opcode.SMSG_GUILD_SEND_PLAYER_LOGIN_STATUS, 0x1A1A}, // 5.4.7 18019
            {Opcode.SMSG_GUILD_XP, 0x1A51}, // 5.4.7 18019
            {Opcode.SMSG_GUILD_XP_GAIN, 0x1A11}, // 5.4.7 18019
            {Opcode.SMSG_HIGHEST_THREAT_UPDATE, 0x0761}, // 5.4.7 18019
            {Opcode.SMSG_HOTFIX_NOTIFY_BLOB, 0x0C81}, // 5.4.7 18019
            {Opcode.SMSG_INITIALIZE_FACTIONS, 0x11E1}, // 5.4.7 18019
            {Opcode.SMSG_INITIAL_SETUP, 0x12E0}, // 5.4.7 18019
            {Opcode.SMSG_INIT_WORLD_STATES, 0x0F03}, // 5.4.7 18019
            {Opcode.SMSG_INSPECT_HONOR_STATS, 0x1429}, // 5.4.7 18019
            {Opcode.SMSG_INSPECT_RATED_BG_STATS, 0x046B}, // 5.4.7 18019
            ...
            {Opcode.SMSG_INVENTORY_CHANGE_FAILURE, 0x0F49}, // 5.4.7 18019
            {Opcode.SMSG_ITEM_ENCHANT_TIME_UPDATE, 0x0660}, // 5.4.7 18019
            {Opcode.SMSG_ITEM_PURCHASE_REFUND_RESULT, 0x153A}, // 5.4.7 18019
            {Opcode.SMSG_ITEM_PUSH_RESULT, 0x04A1}, // 5.4.7 18019
            {Opcode.SMSG_ITEM_REFUND_INFO_RESPONSE, 0x04A0}, // 5.4.7 18019
            {Opcode.SMSG_ITEM_TIME_UPDATE, 0x1F5B}, // 5.4.7 18019
            {Opcode.SMSG_ITEM_UPGRADE_RESULT, 0x0888}, // 5.4.7 18019
            {Opcode.SMSG_LEARNED_SPELL, 0x0C99}, // 5.4.7 18019
            {Opcode.SMSG_LEVEL_UP_INFO, 0x0E6A}, // 5.4.7 18019
            {Opcode.SMSG_LFG_BOOT_PROPOSAL_UPDATE, 0x1521}, // 5.4.7 18019
            {Opcode.SMSG_LFG_DISABLED, 0x171A}, // 5.4.7 18019
            {Opcode.SMSG_LFG_JOIN_RESULT, 0x12E9}, // 5.4.7 18019
            {Opcode.SMSG_LFG_OFFER_CONTINUE, 0x0F0A}, // 5.4.7 18019
            {Opcode.SMSG_LFG_PLAYER_INFO, 0x13B0}, // 5.4.7 18019
            {Opcode.SMSG_LFG_PLAYER_REWARD, 0x0D21}, // 5.4.7 18019
            {Opcode.SMSG_LFG_PROPOSAL_UPDATE, 0x0C23}, // 5.4.7 18019
            {Opcode.SMSG_LFG_QUEUE_STATUS, 0x0D40}, // 5.4.7 18019
            {Opcode.SMSG_LFG_ROLE_CHECK_UPDATE, 0x0541}, // 5.4.7 18019
            ...
            {Opcode.SMSG_LFG_UPDATE_STATUS, 0x1661}, // 5.4.7 18019
            ...
            {Opcode.SMSG_LOAD_EQUIPMENT_SET, 0x1520}, // 5.4.7 18019
            {Opcode.SMSG_LOGIN_SET_TIME_SPEED, 0x0F4A}, // 5.4.7 18019
            {Opcode.SMSG_LOGIN_VERIFY_WORLD, 0x0603}, // 5.4.7 18019
            {Opcode.SMSG_LOGOUT_CANCEL_ACK, 0x0E0A}, // 5.4.7 18019
            {Opcode.SMSG_LOGOUT_COMPLETE, 0x0429}, // 5.4.7 18019
            {Opcode.SMSG_LOGOUT_RESPONSE, 0x0D2B}, // 5.4.7 18019
            {Opcode.SMSG_LOG_XP_GAIN, 0x1613}, // 5.4.7 18019
            {Opcode.SMSG_LOOT_ALL_PASSED, 0x0126}, // 5.4.7 18019
            {Opcode.SMSG_LOOT_MONEY_NOTIFY, 0x1F49}, // 5.4.7 18019
            {Opcode.SMSG_LOOT_RELEASE, 0x14A2}, // 5.4.7 18019
            {Opcode.SMSG_LOOT_REMOVED, 0x0D00}, // 5.4.7 18019
            {Opcode.SMSG_LOOT_RESPONSE, 0x1F41}, // 5.4.7 18019
            ...
            {Opcode.SMSG_MAIL_LIST_RESULT, 0x0401}, // 5.4.7 18019
            ...
            {Opcode.SMSG_MONEY_NOTIFY, 0x05E2}, // 5.4.7 18019 - CHECK!
            {Opcode.SMSG_MOTD, 0x0E20}, // 5.4.7 18019
            ...
            {Opcode.SMSG_MOVE_ROOT, 0x198B}, // 5.4.7 18019
            {Opcode.SMSG_MOVE_SET_ACTIVE_MOVER, 0x129A}, // 5.4.7 18019
            {Opcode.SMSG_MOVE_SET_CAN_FLY, 0x01F4}, // 5.4.7 18019
            {Opcode.SMSG_MOVE_SET_COLLISION_HEIGHT, 0x0DB0}, // 5.4.7 18019
            {Opcode.SMSG_MOVE_SET_FLIGHT_BACK_SPEED, 0x13D2}, // 5.4.7 18019
            {Opcode.SMSG_MOVE_SET_FLIGHT_SPEED, 0x02DC}, // 5.4.7 18019
            ...
            {Opcode.SMSG_MOVE_SET_RUN_SPEED, 0x1B9B}, // 5.4.7 18019
            {Opcode.SMSG_MOVE_SET_SWIM_BACK_SPEED, 0x015D}, // 5.4.7 18019
            {Opcode.SMSG_MOVE_SET_SWIM_SPEED, 0x01D4}, // 5.4.7 18019
            {Opcode.SMSG_MOVE_SET_TURN_RATE, 0x1DB0}, // 5.4.7 18019
            {Opcode.SMSG_MOVE_SET_WALK_SPEED, 0x00A0}, // 5.4.7 18019
            {Opcode.SMSG_MOVE_TELEPORT, 0x00D5}, // 5.4.7 18019
            {Opcode.SMSG_MOVE_UNROOT, 0x1D8A}, // 5.4.7 18019
            {Opcode.SMSG_MOVE_UNSET_CAN_FLY, 0x1D81}, // 5.4.7 18019
            {Opcode.SMSG_MOVE_UNSET_HOVERING, 0x1AC0}, // 5.4.7 18019
            {Opcode.SMSG_MOVE_UPDATE, 0x1CB2}, // 5.4.7 18019
            {Opcode.SMSG_MOVE_UPDATE_COLLISION_HEIGHT, 0x179A}, // 5.4.7 18019 - CHECK!
            {Opcode.SMSG_MOVE_UPDATE_FLIGHT_SPEED, 0x17D9}, // 5.4.7 18019
            {Opcode.SMSG_MOVE_UPDATE_RUN_BACK_SPEED, 0x1BC2}, // 5.4.7 18019
            {Opcode.SMSG_MOVE_UPDATE_RUN_SPEED, 0x1388}, // 5.4.7 18019
            {Opcode.SMSG_MOVE_UPDATE_SWIM_SPEED, 0x1893}, // 5.4.7 18019
            {Opcode.SMSG_MOVE_UPDATE_WALK_SPEED, 0x139A}, // 5.4.7 18019
            {Opcode.SMSG_MOVE_WATER_WALK, 0x1290}, // 5.4.7 18019
            {Opcode.SMSG_NEW_TAXI_PATH, 0x13A3}, // 5.4.7 18019
            {Opcode.SMSG_NEW_WORLD, 0x05AB}, // 5.4.7 18019
            {Opcode.SMSG_NOTIFICATION, 0x15A1}, // 5.4.7 18019
            {Opcode.SMSG_ON_CANCEL_EXPECTED_RIDE_VEHICLE_AURA, 0x0C0A}, // 5.4.7 18019
            {Opcode.SMSG_ON_MONSTER_MOVE, 0x12D8}, // 5.4.7 18019
            {Opcode.SMSG_PARTY_COMMAND_RESULT, 0x1787}, // 5.4.7 18019
            {Opcode.SMSG_PARTY_KILL_LOG, 0x0F23}, // 5.4.7 18019
            ...
            {Opcode.SMSG_PET_CAST_FAILED, 0x1D33}, // 5.4.7 18019
            ...
            {Opcode.SMSG_PHASE_SHIFT_CHANGE, 0x1D52}, // 5.4.7 18019
            {Opcode.SMSG_PLAYED_TIME, 0x1C69}, // 5.4.7 18019
            {Opcode.SMSG_PLAYER_BOUND, 0x00E8}, // 5.4.7 18019
            ...
            {Opcode.SMSG_PLAYER_VEHICLE_DATA, 0x1F29}, // 5.4.7 18019
            {Opcode.SMSG_PLAY_OBJECT_SOUND, 0x0C43}, // 5.4.7 18019
            {Opcode.SMSG_PLAY_SCENE, 0x1748}, // 5.4.7 18019 Not implemented - CHECK!
            {Opcode.SMSG_PLAY_SOUND, 0x0E22}, // 5.4.7 18019
            {Opcode.SMSG_PLAY_SPELL_VISUAL, 0x1F3B}, // 5.4.7 18019 Not implemented - CHECK!
            {Opcode.SMSG_PLAY_SPELL_VISUAL_KIT, 0x0500}, // 5.4.7 18019
            {Opcode.SMSG_PONG, 0x15B1}, // 5.4.7 18019
            {Opcode.SMSG_POWER_UPDATE, 0x1441}, // 5.4.7 18019
            {Opcode.SMSG_PRE_RESSURECT, 0x1F52}, // 5.4.7 18019
            {Opcode.SMSG_PVP_CREDIT, 0x13BB}, // 5.4.7 18019
            {Opcode.SMSG_PVP_LOG_DATA, 0x076A}, // 5.4.7 18019
            {Opcode.SMSG_PVP_OPTIONS_ENABLED, 0x1460}, // 5.4.7 18019
            {Opcode.SMSG_PVP_SEASON, 0x00E1}, // 5.4.7 18019
            {Opcode.SMSG_QUERY_CREATURE_RESPONSE, 0x00E0}, // 5.4.7 18019
            {Opcode.SMSG_QUERY_GAME_OBJECT_RESPONSE, 0x066A}, // 5.4.7 18019
            {Opcode.SMSG_QUERY_GUILD_INFO_RESPONSE, 0x1953}, // 5.4.7 18019
            {Opcode.SMSG_QUERY_ITEM_TEXT_RESPONSE, 0x06AD}, // 5.4.7 18019
            {Opcode.SMSG_QUERY_NEXT_MAIL_TIME, 0x1C20}, // 5.4.7 18019
            {Opcode.SMSG_QUERY_NPC_TEXT_RESPONSE, 0x10E0}, // 5.4.7 18019
            {Opcode.SMSG_QUERY_PAGE_TEXT_RESPONSE, 0x1653}, // 5.4.7 18019
            {Opcode.SMSG_QUERY_PET_NAME_RESPONSE, 0x1F08}, // 5.4.7 18019
            {Opcode.SMSG_QUERY_PLAYER_NAME_RESPONSE, 0x1E5B}, // 5.4.7 18019
            {Opcode.SMSG_QUERY_QUEST_INFO_RESPONSE, 0x0F13}, // 5.4.7 18019
            {Opcode.SMSG_QUERY_TIME_RESPONSE, 0x0E2A}, // 5.4.7 18019
            {Opcode.SMSG_QUEST_CONFIRM_ACCEPT, 0x0351}, // 5.4.7 18019
            {Opcode.SMSG_QUEST_GIVER_INVALID_QUEST, 0x1944}, // 5.4.7 18019 //0F4D
            {Opcode.SMSG_QUEST_GIVER_OFFER_REWARD_MESSAGE, 0x0F77}, // 5.4.7 18019
            {Opcode.SMSG_QUEST_GIVER_QUEST_COMPLETE, 0x0D54}, // 5.4.7 18019
            {Opcode.SMSG_QUEST_GIVER_QUEST_DETAILS, 0x0966}, // 5.4.7 18019
            {Opcode.SMSG_QUEST_GIVER_QUEST_FAILED, 0x0B70}, // 5.4.7 18019
            {Opcode.SMSG_QUEST_GIVER_QUEST_LIST_MESSAGE, 0x0733}, // 5.4.7 18019
            {Opcode.SMSG_QUEST_GIVER_REQUEST_ITEMS, 0x0A32}, // 5.4.7 18019
            {Opcode.SMSG_QUEST_GIVER_STATUS, 0x0D7E}, // 5.4.7 18019
            {Opcode.SMSG_QUEST_GIVER_STATUS_MULTIPLE, 0x0F79}, // 5.4.7 18019
            {Opcode.SMSG_QUEST_LOG_FULL, 0x0B19}, // 5.4.7 18019
            {Opcode.SMSG_QUEST_NPC_QUERY_RESPONSE, 0x0957}, // 5.4.7 18019
            {Opcode.SMSG_QUEST_POI_QUERY_RESPONSE, 0x0F5F}, // 5.4.7 18019
            ...
            {Opcode.SMSG_READY_CHECK_RESPONSE, 0x1641}, // 5.4.7 18019
            {Opcode.SMSG_READY_CHECK_STARTED, 0x072A}, // 5.4.7 18019
            {Opcode.SMSG_READ_ITEM_RESULT_OK, 0x022D}, // 5.4.7 18019
            {Opcode.SMSG_REALM_QUERY_RESPONSE, 0x1652}, // 5.4.7 18019
            {Opcode.SMSG_REALM_SPLIT, 0x145A}, // 0x0708, // 5.4.7 18019 - CHECK!
            {Opcode.SMSG_RECEIVED_MAIL, 0x116E}, // 0x0D60, // 5.4.7 18019 - CHECK!
            {Opcode.SMSG_REFORGE_RESULT, 0x1601}, // 5.4.7 18019
            ...
            {Opcode.SMSG_RESPOND_INSPECT_ACHIEVEMENTS, 0x04E1}, // 5.4.7 18019
            ...
            {Opcode.SMSG_SCENARIO_POIS, 0x10E9}, // 5.4.7 18019 Not implemented - CHECK!
            {Opcode.SMSG_SCENARIO_PROGRESS_UPDATE, 0x167B}, // 5.4.7 18019 Not implemented - CHECK!
            {Opcode.SMSG_SCENARIO_STATE, 0x1E20}, // 5.4.7 18019 Not implemented - CHECK!
            {Opcode.SMSG_SELL_ITEM, 0x1468}, // 5.4.7 18019
            {Opcode.SMSG_SEND_KNOWN_SPELLS, 0x1B05}, // 5.4.7 18019
            {Opcode.SMSG_SEND_RAID_TARGET_UPDATE_ALL, 0x1620}, // 5.4.7 18019
            {Opcode.SMSG_SEND_RAID_TARGET_UPDATE_SINGLE, 0x1F3A}, // 5.4.7 18019
            {Opcode.SMSG_SEND_UNLEARN_SPELLS, 0x1B3E}, // 5.4.7 18019 Not implemented - CHECK! //047E
            {Opcode.SMSG_SERVER_TIME, 0x047E}, // 5.4.7 18019 - CHECK!
            {Opcode.SMSG_SETUP_CURRENCY, 0x1E3A}, // 5.4.7 18019
            ...
            {Opcode.SMSG_SET_FLAT_SPELL_MODIFIER, 0x0179}, // 5.4.7 18019
            {Opcode.SMSG_SET_FORCED_REACTIONS, 0x060A}, // 5.4.7 18019
            {Opcode.SMSG_SET_PCT_SPELL_MODIFIER, 0x193C}, // 5.4.7 18019
            {Opcode.SMSG_SET_PET_SPECIALIZATION, 0x1640}, // 5.4.7 18019
            {Opcode.SMSG_SET_PLAYER_DECLINED_NAMES_RESULT, 0x00E9}, // 5.4.7 18019
            {Opcode.SMSG_SET_PLAY_HOVER_ANIM, 0x0729}, // 5.4.7 18019 Not implemented - CHECK!
            {Opcode.SMSG_SET_PROFICIENCY, 0x1E3B}, // 5.4.7 18019
            {Opcode.SMSG_SET_TIME_ZONE_INFORMATION, 0x0C2B}, // 5.4.7 18019
            {Opcode.SMSG_SET_VIGNETTE, 0x05A1}, // 5.4.7 18019 Not implemented - CHECK!
            {Opcode.SMSG_SHOW_BANK, 0x060B}, // 5.4.7 18019
            ...
            {Opcode.SMSG_SPELL_CATEGORY_COOLDOWN, 0x053B}, // 5.4.7 18019
            {Opcode.SMSG_SPELL_CHANNEL_START, 0x1B15}, // 5.4.7 18019
            {Opcode.SMSG_SPELL_CHANNEL_UPDATE, 0x087B}, // 5.4.7 18019
            {Opcode.SMSG_SPELL_COOLDOWN, 0x1B14}, // 5.4.7 18019
            {Opcode.SMSG_SPELL_DELAYED, 0x015B}, // 5.4.7 18019
            {Opcode.SMSG_SPELL_DISPELL_LOG, 0x0919}, // 5.4.7 18019
            {Opcode.SMSG_SPELL_ENERGIZE_LOG, 0x0071}, // 5.4.7 18019
            {Opcode.SMSG_SPELL_EXECUTE_LOG, 0x19B4}, // 5.4.7 18019
            {Opcode.SMSG_SPELL_FAILED_OTHER, 0x1E7A}, // 5.4.7 18019
            {Opcode.SMSG_SPELL_FAILURE, 0x0E03}, // 5.4.7 18019
            {Opcode.SMSG_SPELL_GO, 0x0851}, // 5.4.7 18019
            {Opcode.SMSG_SPELL_HEAL_LOG, 0x1BBF}, // 5.4.7 18019
            {Opcode.SMSG_SPELL_INSTAKILL_LOG, 0x0D7A}, // 5.4.7 18019
            {Opcode.SMSG_SPELL_INTERRUPT_LOG, 0x091A}, // 5.4.7 18019
            {Opcode.SMSG_SPELL_NON_MELEE_DAMAGE_LOG, 0x0172}, // 5.4.7 18019
            {Opcode.SMSG_SPELL_OR_DAMAGE_IMMUNE, 0x1B9F}, // 5.4.7 18019
            {Opcode.SMSG_SPELL_PERIODIC_AURA_LOG, 0x051B}, // 5.4.7 18019
            {Opcode.SMSG_SPELL_START, 0x0130}, // 5.4.7 18019
            ...
            {Opcode.SMSG_SPLINE_MOVE_SET_WALK_SPEED, 0x0155}, // 5.4.7 18019
            {Opcode.SMSG_SPLINE_MOVE_SET_WATER_WALK, 0x0DB3}, // 5.4.7 18019
            {Opcode.SMSG_SPLINE_MOVE_UNROOT, 0x1698}, // 5.4.7 18019
            ...
            {Opcode.SMSG_STAND_STATE_UPDATE, 0x0C48}, // 5.4.7 18019
            ...
            {Opcode.SMSG_SUSPEND_COMMS, 0x10B0}, // 5.4.7 18019 Not implemented - CHECK!
            {Opcode.SMSG_TAXI_NODE_STATUS, 0x0E23}, // 5.4.7 18019
            {Opcode.SMSG_TEXT_EMOTE, 0x0522}, // 5.4.7 18019
            {Opcode.SMSG_THREAT_CLEAR, 0x1D7A}, // 5.4.7 18019
            {Opcode.SMSG_THREAT_REMOVE, 0x1E29}, // 5.4.7 18019
            {Opcode.SMSG_THREAT_UPDATE, 0x1708}, // 5.4.7 18019
            {Opcode.SMSG_TIME_SYNC_REQUEST, 0x12F1}, // 5.4.7 18019
            {Opcode.SMSG_TITLE_EARNED, 0x0F28}, // 5.4.7 18019
            {Opcode.SMSG_TITLE_LOST, 0x13E0}, // 5.4.7 18019
            {Opcode.SMSG_TOTEM_CREATED, 0x0608}, // 5.4.7 18019
            ...
            {Opcode.SMSG_TRAINER_LIST, 0x1509}, // 5.4.7 18019
            //{Opcode.SMSG_TRAINER_SERVICE, 0x157B}, // 5.4.7 18019
            {Opcode.SMSG_TRANSFER_ABORTED, 0x0648}, // 5.4.7 18019
            {Opcode.SMSG_TRANSFER_PENDING, 0x0440}, // 5.4.7 18019
            {Opcode.SMSG_TRIGGER_CINEMATIC, 0x04CC}, // 5.4.7 18019
            {Opcode.SMSG_TRIGGER_MOVIE, 0x0D0A}, // 5.4.7 18019
            {Opcode.SMSG_TURN_IN_PETITION_RESULT, 0x0509}, // 5.4.7 18019
            {Opcode.SMSG_TUTORIAL_FLAGS, 0x10A7}, // 5.4.7 18019
            {Opcode.SMSG_UI_TIME, 0x0C22}, // 5.4.7 18019
            {Opcode.SMSG_UNLEARNED_SPELLS, 0x05E3}, // 5.4.7 18019
            {Opcode.SMSG_UPDATE_ACCOUNT_DATA, 0x13B9}, // 5.4.7 18019
            {Opcode.SMSG_UPDATE_ACTION_BUTTONS, 0x1768}, // 5.4.7 18019
            ...
            {Opcode.SMSG_UPDATE_OBJECT, 0x1725}, // 5.4.7 18019
            {Opcode.SMSG_UPDATE_TALENT_DATA, 0x0C68}, // 5.4.7 18019
            {Opcode.SMSG_UPDATE_WORLD_STATE, 0x1D13}, // 5.4.7 18019
            {Opcode.SMSG_VENDOR_INVENTORY, 0x0D2A}, // 5.4.7 18019
            {Opcode.SMSG_VOID_ITEM_SWAP_RESPONSE, 0x0E2B}, // 5.4.7 18019
            {Opcode.SMSG_VOID_STORAGE_CONTENTS, 0x0C93}, // 5.4.7 18019
            {Opcode.SMSG_VOID_STORAGE_FAILED, 0x1569}, // 5.4.7 18019
            {Opcode.SMSG_VOID_STORAGE_TRANSFER_CHANGES, 0x05A8}, // 5.4.7 18019
            {Opcode.SMSG_VOID_TRANSFER_RESULT, 0x00E3}, // 5.4.7 18019
            {Opcode.SMSG_WARDEN_DATA, 0x14EB}, // 5.4.7 18019
            {Opcode.SMSG_WEATHER, 0x0F41}, // 5.4.7 18019
            {Opcode.SMSG_WEEKLY_RESET_CURRENCY, 0x0620}, // 5.4.7 18019 - CHECK!
            {Opcode.SMSG_WEEKLY_SPELL_USAGE, 0x1D04}, // 5.4.7 18019 - Not implemented - CHECK!
            {Opcode.SMSG_WHO, 0x0460}, // 5.4.7 18019
            {Opcode.SMSG_WHO_IS, 0x1513}, // 5.4.7 18019
            {Opcode.SMSG_WORLD_SERVER_INFO, 0x1D01}, // 5.4.7 18019
            {Opcode.SMSG_XP_GAIN_ABORTED, 0x1E32}, // 5.4.7 18019 - Not finished - CHECK!
