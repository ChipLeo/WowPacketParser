...
namespace WowPacketParserModule.V5_4_8_18414.Parsers
{
    public static class UnkHandler
    {
        ...
        [Parser(Opcode.SMSG_UNK_168A)]
        public static void HandleSUnk168A(Packet packet)
        {
        ...
        [Parser(Opcode.SMSG_UNK_1843)]
        public static void HandleSUnk1843(Packet packet)
        {
        ...
        [Parser(Opcode.SMSG_UNK_1A9F)]
        public static void HandleSUnk1A9F(Packet packet)
        {
        ...
        [Parser(Opcode.SMSG_UNK_1E8E)]
        public static void HandleSUnk1E8E(Packet packet)
        {
            packet.ReadInt32("unkInt32");
        }
